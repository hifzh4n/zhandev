      ...
      >
        ...
        >
          <div className="relative group">
            ...
            <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-4 sm:p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  ...
                  variant="cool"
                  disabled={isLoading}
                  className="w-full relative group/button mt-5 overflow-hidden"
                >
                  <div className="absolute inset-0 bg-white/10 rounded-lg blur-lg opacity-0 group-hover/button:opacity-70 transition-opacity duration-300" />
                  
                  <div className="relative overflow-hidden bg-white text-black font-medium h-10 rounded-lg transition-all duration-300 flex items-center justify-center w-full">
                    <motion.div 
